...
public class TestDataLoader implements CommandLineRunner {
    ...
    public TestDataLoader(UserService userService, TeamService teamService, DataSourceService dataSourceService, ParameterService parameterService, MeasurementService measurementService) {
    ...
    private void addTestUsersToTeams(List<User> users, List<Team> teams) {
        ...
        hamilton = userService.addUserToTeam(hamilton, mercedes);
        hamilton = userService.addUserToTeam(hamilton, mercedesEngine);
        bottas = userService.addUserToTeam(bottas, mercedes);
        bottas = userService.addUserToTeam(bottas, mercedesEngine);
        verstappen = userService.addUserToTeam(verstappen, redbull);
    ...
    private List<Team> createTestTeams() {
        ...
        Team mercedes = teamService.createTeam("Mercedes",
        ...
        Team redbull = teamService.createTeam("Red Bull Racing",
        ...
        Team mclarend = teamService.createTeam("McLaren",
        ...
        Team ferrari = teamService.createTeam("Ferrari",
        ...
        Team mercedesEngine = teamService.createTeam("Mercedes Engine supplier", "Supplier of Mercedes engines");
        Team renaultEngine = teamService.createTeam("Renault Engine supplier", "Supplier of Renault engines");
        Team hondaEngine = teamService.createTeam("Honda Engine supplier", "Supplier of Honda engines");
        Team ferrariEngine = teamService.createTeam("Ferrari Engine supplier", "Supplier of Ferrari engines");
    ...
    private List<User> createTestUsers() {
        ...
        User hamilton = userService.createUser("Lewis Hamilton", "12345");
        User bottas = userService.createUser("Valtteri Bottas", "password");
        User verstappen = userService.createUser("Max Verstappen", "1234");
        User norris = userService.createUser("Lando Norris", "ggboyzz");
